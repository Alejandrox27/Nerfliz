...
"")
        ...
        self.closeMessageBtn.setMinimumSize(QtCore.QSize(24, 24))
        self.closeMessageBtn.setMaximumSize(QtCore.QSize(24, 24))
        self.closeMessageBtn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.closeMessageBtn.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/x.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("images/alert_triangle_white.png"))
        ...
        self.okBtn = QtWidgets.QPushButton(self.frame_3)
